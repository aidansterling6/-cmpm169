...
void main() {
  ...
  for(int i = 0; i < MaxLen; i++){
    ...
    if(true || i == 3){
    vec3 p1v1 = vec3(cos(YRot)*P1x[i] - sin(YRot)*P1z[i], P1y[i], cos(YRot)*P1z[i] + sin(YRot)*P1x[i]);
      
    vec3 p2v1 = vec3(cos(YRot)*P2x[i] - sin(YRot)*P2z[i], P2y[i], cos(YRot)*P2z[i] + sin(YRot)*P2x[i]);
      
    vec3 p3v1 = vec3(cos(YRot)*P3x[i] - sin(YRot)*P3z[i], P3y[i], cos(YRot)*P3z[i] + sin(YRot)*P3x[i]);
      
      
    vec3 p1 = vec3(p1v1.x, cos(XRot)*p1v1.y - sin(XRot)*p1v1.z, cos(XRot)*p1v1.z + sin(XRot)*p1v1.y)*160.0;
    vec3 p2 = vec3(p2v1.x, cos(XRot)*p2v1.y - sin(XRot)*p2v1.z, cos(XRot)*p2v1.z + sin(XRot)*p2v1.y)*160.0;
    vec3 p3 = vec3(p3v1.x, cos(XRot)*p3v1.y - sin(XRot)*p3v1.z, cos(XRot)*p3v1.z + sin(XRot)*p3v1.y)*160.0;
